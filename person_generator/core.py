...
SURNAMES = [
    ...
    'Гриневская', 'Гребневский', 'Шуфрич', 'Зварыч', 'Андрухович', 'Шлюхевич', 'Токар', 'Кобзар', 'Житар', 'Рымар',
    ...
    'Абрамович', 'Авнет', 'Азив', 'Айверовская', 'Айзенштат', 'Айн', 'Алкен', 'Алтер', 'Альперн', 'Альтер', 'Ануш',
    ...
    'Берштейн', 'Бибер', 'Бламенфельд', 'Бланкштейн', 'Блонский', 'Блюштейн', 'Бобес', 'Бобривицкая', 'Богуславяк',
    'Бойдан', 'Бомхиль', 'Борд', 'Боренштейн', 'Бортновский', 'Борштейн', 'Борщевский', 'Ботхиль', 'Боцковский',
    'Бочковский', 'Боярский', 'Бренер', 'Брик', 'Брискер', 'Брозовская', 'Бройде', 'Брудный', 'Бублицкий', 'Буриская',
    'Бурыш', 'Бялодворская', 'Бялостокский', 'Вайнилис', 'Вайнтруб', 'Вайншель', 'Вайнштейн', 'Вайскопф', 'Вапнярх',
    ...
    'Заблудовский', 'Завадский', 'Завольский', 'Зайвель', 'Зайфельд', 'Закин', 'Заренская', 'Здановский', 'Зейлицкий',
    ...
    'Капуста', 'Карелишко', 'Карчак', 'Катц', 'Кац', 'Кацин', 'Кацын', 'Кивенская', 'Кирзнер', 'Киршенбаум', 'Клейн',
    'Клюк', 'Книженик', 'Ковадло', 'Колодник', 'Копляндский', 'Коруж', 'Корчинский', 'Корыцкая', 'Косой',
    'Кот-Городецкий', 'Котлер', 'Котляр', 'Кравец', 'Кравник', 'Крейнген', 'Крутак', 'Крынский', 'Кудес', 'Кузнецкий',
    'Купеш', 'Куприц', 'Курлядский', 'Курлянда', 'Куропатова', 'Курцбарт', 'Курцгорц', 'Кусель', 'Кучковская', 'Кушнер',
    'Лабзовская', 'Ланде', 'Ластовский', 'Лащинская', 'Лебедь', 'Лев', 'Левин', 'Левинский', 'Лейбова', 'Лекахмахер',
    ...
    'Малкин', 'Малковский', 'Мальцберг', 'Ман', 'Маневич', 'Маньковская', 'Маранц', 'Марковская', 'Маркус', 'Маровец',
    'Марчиканская', 'Махай(Макай)', 'Медведь', 'Медовник', 'Мелер', 'Меликовский', 'Менакер', 'Миллер', 'Мильнер',
    'Миневич', 'Миткинд', 'Митковский', 'Михелиович', 'Мовшович', 'Монкер', 'Монцик', 'Мостовский', 'Мулер', 'Муляр',
    'Намистович', 'Наревский', 'Начевник', 'Неведомская', 'Немон', 'Ненендик', 'Нетужский', 'Новир', 'Носович', 'Овец',
    ...
    'Саперштейн', 'Сапочковская', 'Сарапник', 'Сарвер', 'Сегал', 'Семятицкая', 'Серачек', 'Серыский', 'Сета',
    'Сибирский', 'Сидлецкая', 'Силовская', 'Симбирский', 'Симятинский', 'Сирота', 'Сич', 'Сладкий', 'Слепак',
    'Смолянская', 'Собель', 'Соболь', 'Соголович', 'Сокол', 'Соколовер', 'Сокольник', 'Соломон', 'Ставер', 'Столь',
    'Суд', 'Сульхес', 'Суляк', 'Суш', 'Сушельский', 'Тевег', 'Тиктин(Тыктин)', 'Токарь', 'Толкоцкая', 'Топорович',
    'Троицкий', 'Трон', 'Тхорицкий', 'Тыкоцкий', 'Тыктин', 'Тыктин', 'ФайнбергонжеФиксель', 'Фарбер', 'Фейдман',
    'Фишбейн', 'Фишер', 'Флейшер', 'Фонер', 'Франк', 'Фридлянская', 'Фридман', 'Фрусловский', 'Фрядлес', 'Фуковская',
    'Хабольский(Хаболевский)', 'Хазан', 'Хазанович', 'Хазацкая', 'Хацкелевич', 'Хацкель', 'Хведюк', 'Хинский',
    'Хмельницкая', 'Холмецкий', 'Хонен', 'Цвейбах', 'Цикаловский', 'Циперман', 'Цицович', 'Цукерман', 'Цыбанский',
    'Цыбулькин', 'Цымерман', 'Чапник', 'Чачкий', 'Черняк', 'Чертик', 'Чесляр', 'Чеховский', 'Чехоцкий', 'Чижевская',
